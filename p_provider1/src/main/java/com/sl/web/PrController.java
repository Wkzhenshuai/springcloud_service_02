...
public class PrController {
    ...
    private final String PUBCLIC_URL = "http://P-PROVIDER/service/provider";
    ...
    public Manager managerParam() {
        ...
        String url = PUBCLIC_URL + "/managerParam?id={0}&username={1}&password={2}";
    ...
    public Manager managerParamMap() {
        ...
        String url = PUBCLIC_URL + "/managerParam?id={id}&username={username}&password={password}";
...
//    put
    ...
    public String managerParamdel2() {
        String[] paramArray = {"1", "das", "lisi"};
        String url = PUBCLIC_URL + "/managerParam?id={0}&username={1}&password={2}";
        ResponseEntity<String> forEntity = restTemplate.getForEntity(url, String.class, paramArray);
